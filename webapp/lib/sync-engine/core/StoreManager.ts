...
export interface StoreManagerConfig {
   ...
   * deferred models. This matches Linear's approach of fetching
   * Issue/Team/User first, then Comment/Reaction/Attachment later.
   *
...
export class StoreManager {
  ...
  /**
   * Full bootstrap — two-phase fetch matching Linear's approach.
   *
