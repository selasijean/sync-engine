...
export class SyncConnection {
  ...
  /**
   * Sequential processing lock. Linear's sync engine says:
   * The engine "performs all steps inside updateLock.runExclusive. This ensures
   * a delta packet is fully processed before processing the next one."
   *
